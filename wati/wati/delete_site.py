...
def delete_site():
    ...
    try:
        ...
        if master_domain:
            frappe.enqueue("wati.wati.delete_site.request_deletion", queue='default', timeout=None, event=None,	is_async=True, job_name=None, now=False, enqueue_after_commit=False, master=master_domain)
            return "Success"
    except:
